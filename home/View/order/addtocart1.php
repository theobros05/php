...
$products = json_decode('[{"id":100,"name":"phone","image":{"source":"../webroot/upload/images/phone.jpg","width":252,"height":250},"colors":[],"price":"150.00"},
{"id":101,"name":"Hard Disk","image":{"source":"../webroot/upload/images/disk.jpg","width":252,"height":250},"colors":[],"price":"250.00"},
{"id":102,"name":"Watch","image":{"source":"../webroot/upload/images/watch.jpg","width":252,"height":250},"colors":[],"price":"300.00"},
{"id":103,"name":"Apple TV","image":{"source":"../webroot/upload/images/tv.jpg","width":252,"height":250},"colors":[],"price":"200.00"}]');
$colors = [
  'black' => 'Black',
  ...
  if (!$cart->isEmpty()) {
    ...
    <p>
      ...
      <div class="pull-right text-right">
        <a href="ordercontroller.php?a=home" class="btn btn-default">Continue Shopping</a>
    ...
    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          <a href="?a=shop" class="navbar-brand">Shopping Inc.</a>
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">
            <li><a href="ordercontroller.php?a=cart" id="li-cart"><i class="fa fa-shopping-cart"></i> Cart (<?php echo $cart->getTotalItem(); ?>)</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <script>
      $(document).ready(function(){
        $('.add-to-cart').on('click', function(e){
          ...
          var $form = $('<form action=ordercontroller.php"?a=cart" method="post" />').html('<input type="hidden" name="add" value=""><input type="hidden" name="id" value="' + id + '"><input type="hidden" name="color" value="' + color + '"><input type="hidden" name="qty" value="' + qty + '">');
          $('body').append($form);
          $form.submit();
        });
        ...
        $('.btn-remove').on('click', function(){
          ...
          var id = $btn.attr('data-id');
          var color = $btn.attr('data-color');
          var $form = $('<form action=ordercontroller.php"?a=cart" method="post" />').html('<input type="hidden" name="remove" value=""><input type="hidden" name="id" value="'+id+'"><input type="hidden" name="color" value="'+color+'">');
          $('body').append($form);
          $form.submit();
        });
        $('.btn-empty-cart').on('click', function(){
          var $form = $('<form action="ordercontroller.php?a=cart" method="post" />').html('<input type="hidden" name="empty" value="">');
          $('body').append($form);
          $form.submit();
        });
      });
